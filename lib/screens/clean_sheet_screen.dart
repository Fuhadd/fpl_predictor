...
class CleanSheetScreen extends StatefulWidget {
  // String selectedTeam = ConstantList.teams[0];
  static const routeName = '/clean_sheet';
  const CleanSheetScreen({super.key});

  @override
  State<CleanSheetScreen> createState() => _CleanSheetScreenState();
}

class _CleanSheetScreenState extends State<CleanSheetScreen> {
            ...
            CustomButton(
              ...
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => const PreGameScreen(
